...
- The first viewport is the journey itself: a cinematic Streckenplan of seven real approaches to the valley — Zürich; Bern, Basel, Genf, St. Gallen (joining at Chur via Sargans) and Luzern (via Zug) through the true rail network; and Lugano arriving from the south over Tirano, up the valley past the Brusio spiral viaduct. Stylised landmark vignettes (Jet d'eau, Zytglogge, Kapellbrücke, Grossmünster, Landwasser viaduct, Lago Bianco, Kreisviadukt, the St. Gallen abbey, Lake Lugano) pop up as the train passes. The camera pulls back at Poschiavo, and the 15-minute walking trail ends at a home icon above the page's own "Casa Maranta" post title — no caption, no duplicate name.
