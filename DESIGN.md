...
- The first viewport is the journey itself: a cinematic Streckenplan of the approaches to the valley — the camera rides close beside the train from the origin city through the real western network (Genf–Lausanne–Fribourg–Bern; Basel and Bern meeting at Olten; Aarau; Zürich HB) and over the Bernina, then pulls back at Poschiavo to reveal the whole line, whose 15-minute walking trail ends at the page's own "Casa Maranta" post title.
